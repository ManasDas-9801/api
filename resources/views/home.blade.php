    ...
    <div class="row mx-4 px-2">
                ...
                <div class="card-header"><b>Insert Employee Detail</b></div>
                  <div class="card-body ">
                    <form action="{{route('store')}}" method="post">
                        ...
                        <input type="text" name="fname" id="" class="form-control mb-2">
                       @error('fname')
                           <p class="text-danger">Required field</p>
                       @enderror
                        <label for="name"> <b> Last Name: </b></label>
                        <input type="text" name="lname" id="" class="form-control mb-2">
                        @error('lname')
                           <p class="text-danger">Required field</p>
                       @enderror
                       ...
                       @enderror
                        ...
                        <input type="number" name="contact" id="" class="form-control mb-2">
                        @error('contact')
                           <p class="text-danger">Required field</p>
                       @enderror
        ...
        <div class="col-lg-8 mx-2">
            <div class="card shadow ">
                <div class="card-header text-center"><b>This is Employee Detail table</b></div>
                <div class="card-body">
                    <table class="table table-striped  table-hover table-responsive ">
                        ...
                        <tr class="text-dark">
                           ...
                           <td>
                                <a href="{{route('update',$r->id)}}" class="btn btn-success">Edit</a>   
                           </td>
